...
# default keyword arguments for transformers.TrainingArguments for supervised
# and semisupervised models. Set_default_args changes this dictionary
# depending what setup of args or args_sup in the train_with_ssl keyword
# arguments.
...
def get_default_ta(logging_dir=''):
    """
    Return the TrainingArguments with the logging_dir setup for semisupervised
    model.
    """
