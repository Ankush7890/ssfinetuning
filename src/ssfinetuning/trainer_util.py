...
class TrainerForCoTraining(BaseForMMTrainer):
    ...
    def __init__(self, epoch_per_cotrain=2, exchange_threshold=20, ntimes_before_saturation=2, p_threshold=0.65,
                 use_min_lr_scheduler=True, min_lr=1e-07, show_exchange=True, max_passes=1, *args, **kwargs):
...
class TrainerForNoisyStudent(BaseForMMTrainer):
    ...
    def __init__(self, min_lr=1e-07, epoch_per_ts_iter=1, ts_iter=3, ntimes_before_saturation=2,
                 reduce_init_lr_factor=1, use_min_lr_scheduler=None, *args, **kwargs):
